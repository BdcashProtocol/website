document.getElementById("button-started").addEventListener("click", function () {
        $.showAlert({
            ...
            '<li style="list-style: none;display:inline-block;" ><a href="/download"><h1 class="icofont icofont-wallet"></h1>Get Wallets</a></li>'+
            ...
            '<li style="list-style: none;display:inline-block;" ><a href="/markets"><h1 class="icofont icofont-coins"></h1>Get BDECO in market</a></li>'+
            ' </ul>'+
            '</div></div></div>'
